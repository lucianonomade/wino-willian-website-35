        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in perspective-container">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              <button 
                className="cyber-button px-8 py-4 text-lg font-bold text-white relative z-10 group"
              ...
              <button 
                className="glass-morphism border border-cyan-500/50 rounded-lg px-8 py-4 text-lg font-semibold text-cyan-400 hover:bg-cyan-500/10 hover:border-cyan-500 transition-all duration-300 card-3d"
            ...
            <div className="relative floating-3d">
              ...
              <div className="relative z-10 p-8">
                <div className="relative">
                  {/* Rotating Ring */}
                  <div className="absolute inset-0 rounded-full border-4 border-cyan-500/30 animate-spin" style={{animationDuration: '20s'}}></div>
                  <div className="absolute inset-4 rounded-full border-2 border-purple-500/20 animate-spin" style={{animationDuration: '15s', animationDirection: 'reverse'}}></div>
                  ...
                  <div className="relative z-10 rounded-full overflow-hidden border-4 border-gradient-to-r from-cyan-500 to-purple-600 p-1">
                    <img 
                      ...
                      className="w-full max-w-md mx-auto rounded-full bg-gradient-to-br from-slate-800 to-slate-900"
                    />
                  </div>
                  ...
                  <div className="absolute -bottom-4 -left-4 p-3 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full animate-pulse" style={{animationDelay: '1s'}}>
